...
<body style="font-size: 18px;">
  <form method="POST" action="hasil-form-regis.php" class="container mt-5">
    <fieldset class="border border-dark p-3 rounded" style="background-color: Thistle;">
      ...
      <div class="form-group row">
        ...
        <div class="col-8">
          <div class="input-group">
            ...
            <input id="nim" name="nim" placeholder="*01101010101" type="text" class="form-control" required="required" pattern="[0-9]{10}" title="NIM harus 10 digit angka">
          </div>
        </div>
      </div>
      <div class="form-group row">
        ...
        <div class="col-8">
          <div class="input-group">
            ...
            <input id="nama_lengkap" name="nama_lengkap" placeholder="*Amaa" type="text" class="form-control" required="required" maxlength="50" minlength="3">
          </div>
        </div>
      </div>
      <div class="form-group row">
