...
<body>
  <div class="mx-auto mt-5 border border-2 border-lavender-blush p-3 bg-lavender-blush text-dark rounded" style="width: 45%;">
    <h3 class="text-center">Hasil Registrasi IT Club Data Science</h3>
    <table class="table border border-2 border-lavender-blush mt-3 text-dark w-75 mx-auto">
      <thead>
        <tr>
          <td>NIM</td>
          <td>:</td>
    ...
    <div class="text-center my-3">
      <a href="form-registrasi.php" class="btn btn-maroon">Kembali</a>
    </div>
  </div>
